...
//the "maze". the index of the outer array is 7. the index of each inner array is x. mirrored up/down visually compared to maze as drawn to avoid negatives in y axis. the content of the inner arrays is the room type, which refers to the index of the roomTypes array.
const rooms = [
    [0, 11, 8, 8, 12, 8, 8, 9],
    [0, 6, 0, 0, 6, 0, 0, 6],
    [0, 6, 0, 0, 6, 0, 0, 6],
